...
class TrainOptions():
    ...
    def initialize(self):
        ...
        parser.add_argument('--ModelName', help='AE/MemAE/MemVAE',type=str, default='MemAE')
        ...
        ## added
        parser.add_argument('--UseExModel', help='Use ex-model', type=str2bool, default=True)
        parser.add_argument('--Summary', help='Use Summary', type=str2bool, default=False)
        parser.add_argument('--Loss', help='change loss function mse or ssim', type=str, default = "")
